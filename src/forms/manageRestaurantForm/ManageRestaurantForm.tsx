...
const formSchema = z.object({
  ...
  deliveryPrice: z.coerce.number({
    ...
    invalid_type_error: "Delievery price must be a valid number!",
  }),
  estimatedDeliveryTime: z.coerce.number({
    required_error: "Estimated delivery time is required!",
    invalid_type_error: "Estimated delievery time must be a valid number!",
  }),
  ...
  return (
    <Form {...form}>
      <form
        ...
        className="space-y-8 bg-gray-50 py-10 rounded-lg">
        <DetailsSection />
        <Separator />
        <CuisinesSection />
        <Separator />
